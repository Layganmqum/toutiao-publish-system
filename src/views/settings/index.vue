<template>
  <div class="settings-container">
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="15">
          <el-form ref="user-form" :model="user" :rules="userRules" label-width="80px">
    ...
    return {
      ...
      userRules: {
        name: [
          ...
          { pattern: /^.{1,7}$/, message: '请输入正确的媒体名称', trigger: 'blur' }
        ]
      }
    }
  },
  ...
  methods: {
    ...
    onDialogOpened () {
      ...
      this.cropper = new Cropper(image, {
        viewMode: 1, // 裁剪框不超过画布大小
        dragMode: 'none', // 画布是否可拖动
        aspectRatio: 1,
        cropBoxResizable: false // 裁剪框是否可以伸缩
